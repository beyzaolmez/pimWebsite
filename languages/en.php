<?php
	$lang = array(
        ...
        //footer
        "footer" => "brought to you by team A",

        //from the about us page
        "h1" => "Our goal in A.I. P.I.M.",
		"h2" => "Why A.I. P.I.M.?",
        "h3" => "About team A",
		"p1" => "A.I. P.I.M. was created to make learning Dutch easy and interactive for international students arriving to the Netherlands.",
        ...
        "welcome" => "Welcome,",
		"what" => "What do you want to translate?",
		"text" => "Text",
